...
install_XrayR() {
    ...
    # 写入配置文件
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/wutonyee/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
    ...
    echo "Telegram: https://t.me/wutonyee"
    echo "Github: https://github.com/wutonyee/XrayR-V2Board"
